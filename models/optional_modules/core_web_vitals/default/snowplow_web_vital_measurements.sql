...
, coalesce as (
  ...
  select
    ...
    page_view_count,
    ceil(cast(lcp_{{ var('snowplow__cwv_percentile') }}p as decimal(9,4))*1000) /1000 as lcp_{{ var('snowplow__cwv_percentile') }}p,
    ceil(cast(fid_{{ var('snowplow__cwv_percentile') }}p as decimal(9,4))*1000) /1000 as fid_{{ var('snowplow__cwv_percentile') }}p,
    ceil(cast(cls_{{ var('snowplow__cwv_percentile') }}p as decimal(9,4))*1000) /1000 as cls_{{ var('snowplow__cwv_percentile') }}p,
    ceil(cast(ttfb_{{ var('snowplow__cwv_percentile') }}p as decimal(9,4))*1000) /1000 as ttfb_{{ var('snowplow__cwv_percentile') }}p,
    ceil(cast(inp_{{ var('snowplow__cwv_percentile') }}p as decimal(9,4))*1000) /1000 as inp_{{ var('snowplow__cwv_percentile') }}p,
    m.lcp_result,
    m.fid_result,
    m.cls_result,
    m.ttfb_result,
