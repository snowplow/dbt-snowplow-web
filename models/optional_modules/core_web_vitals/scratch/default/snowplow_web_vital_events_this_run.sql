...
, prep as (
  ...
  select
    ...
    ceil(cast(cwv.cwv_lcp/1000 as decimal(9,4))*1000) /1000 as lcp,
    ceil(cast(cwv.cwv_fcp as decimal(9,4))*1000) /1000 as fcp,
    ceil(cast(cwv.cwv_fid as decimal(9,4))*1000) /1000 as fid,
    ceil(cast(cwv.cwv_cls as decimal(9,4))*1000) /1000 as cls,
    ceil(cast(cwv.cwv_inp as decimal(9,4))*1000) /1000 as inp,
    ceil(cast(cwv.cwv_ttfb as decimal(9,4))*1000) /1000 as ttfb,
