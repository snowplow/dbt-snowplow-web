...
select
  a.contexts_com_snowplowanalytics_snowplow_unified_page_1[0]:id::varchar as page_view_id,
  ...
  a.* exclude(contexts_com_snowplowanalytics_snowplow_unified_page_1, domain_sessionid, domain_userid)
