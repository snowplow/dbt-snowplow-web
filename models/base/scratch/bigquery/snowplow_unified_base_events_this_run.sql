...
select
  a.contexts_com_snowplowanalytics_snowplow_unified_page_1_0_0[safe_offset(0)].id as page_view_id,
  ...
  a.* except(contexts_com_snowplowanalytics_snowplow_unified_page_1_0_0, domain_sessionid, domain_userid)
