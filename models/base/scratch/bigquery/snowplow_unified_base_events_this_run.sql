...
select
  ...
  coalesce(
    ...
    {% if var('snowplow__enable_mobile') %}
      a.unstruct_event_com_snowplowanalytics_mobile_screen_view_1_0_0[safe_offset(0)].id,
    {% endif %}
    null) as view_id,
    ...
    {% endif %}
    {% if var('snowplow__enable_mobile') %}
    a.unstruct_event_com_snowplowanalytics_mobile_screen_view_1_0_0[safe_offset(0)].id as screen_view_id,
    {% endif %}
