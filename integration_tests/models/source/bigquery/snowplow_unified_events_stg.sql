  ...
  select
    *
    ...
    array(
      ...
      from unnest(unstruct_event_com_snowplowanalytics_snowplow_unified_vitals_1_0_0) as json_array
      ) as unstruct_event_com_snowplowanalytics_snowplow_unified_vitals_1_0_0,
