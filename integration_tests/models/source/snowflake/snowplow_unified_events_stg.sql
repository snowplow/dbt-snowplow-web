  ...
  -- page view context is given as json string in csv. Parse json
    ...
    select
      *,
      ...
      unstruct_event_com_snowplowanalytics_snowplow_consent_preferences_1[0].gdpr_applies as gdprApplies,
      unstruct_event_com_snowplowanalytics_snowplow_cmp_visible_1[0]:elapsed_time as elapsedTime,
      unstruct_event_com_snowplowanalytics_snowplow_unified_vitals_1[0].lcp as lcp,
      unstruct_event_com_snowplowanalytics_snowplow_unified_vitals_1[0].fcp as fcp,
      unstruct_event_com_snowplowanalytics_snowplow_unified_vitals_1[0].fid as fid,
      unstruct_event_com_snowplowanalytics_snowplow_unified_vitals_1[0].cls as cls,
      unstruct_event_com_snowplowanalytics_snowplow_unified_vitals_1[0].inp as inp,
      unstruct_event_com_snowplowanalytics_snowplow_unified_vitals_1[0].ttfb as ttfb,
      unstruct_event_com_snowplowanalytics_snowplow_unified_vitals_1[0].navigation_type as navigationType,
